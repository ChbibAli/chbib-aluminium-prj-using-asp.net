<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Checkout.aspx.vb" Inherits="ChbibAuminium.Checkout" %>
...
<body>
  ...
  <div class="con" style="background-color:black;height:135px;margin-top:-4px">
    <header class="d-flex flex-wrap justify-content-center py-3 mb-4 border-bottom">
      ...
      <!--header-->
        <tr><td>
           <h1 style="width:1350px;height:200px;color:white;background:url('images/backallpages.jpg');text-align:center;font-size:56px;margin-top:-26px;padding-top:60px ">Cart</h1><br /><br />
            </td></tr>
         <!--header-->
        ...
        <div id="form1" class="container4">
            <asp:Label ID="Label1" runat="server" Text="Delivery cost:"></asp:Label>
            <asp:DropDownList ID="DropDownList2" runat="server" Height="32px" Width="255px">
                <asp:ListItem Value="..."> Select your Location</asp:ListItem> 
                <asp:ListItem Value="5">Dahye:5$</asp:ListItem>
                <asp:ListItem Value="10">Beirut:20$</asp:ListItem>
                <asp:ListItem Value="20">Saida:20$</asp:ListItem>
                <asp:ListItem Value="35">Nabatieh:35$</asp:ListItem>
                <asp:ListItem Value="45">Sour:45$</asp:ListItem>
                <asp:ListItem Value="20">Zahle:20$</asp:ListItem>
                <asp:ListItem Value="40">Baalbek:40$</asp:ListItem>
                <asp:ListItem Value="20">Jbeil:20$</asp:ListItem>
                <asp:ListItem Value="40">Tripoli:40$</asp:ListItem>
                <asp:ListItem Value="30">Batroun:30$</asp:ListItem>
         ...
         <table class="table cart-desktop">
            ...
            <%For Each dataRow As Data.DataRow In Me.GetItems().Tables(0).Rows  %>
                <tr>
                    <td></td>
                    <td> <p><%=dataRow("name").ToString() %></p></td>
                    <td><img style="width:110px;height:90px" src="<%=dataRow("image").ToString() %>" alt=""/></td>
                    <td><span id="price"><%=dataRow("price").ToString() %></span></td>
            ...
            <br />
            <br />
            <asp:Button style="margin-left:220px" ID="Button2" CssClass="btnsubmit" runat="server" Text="Order" Width="532px" Height="32px" />
        </div>
