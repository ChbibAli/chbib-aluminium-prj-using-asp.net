<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="contactus.aspx.vb" Inherits="ChbibAuminium.Contactus" %>
...
<body>
   ...
   <div class="con" style="background-color:black;height:135px;margin-top:-4px">
    ...
    <!--header h1 start-->
        <tr><td>
           <h1 style="width:1350px;height:200px;color:white;background:url('images/backallpages.jpg');text-align:center;font-size:56px;margin-top:-26px;padding-top:60px ">Contact Us</h1><br /><br />
            </td></tr>
         <!--header h1 end-->
    ...
    <!--titre start-->
        ...
        <section style="margin-top:-57px;margin-bottom:0px;text-align:center;height:80px;"> 
           <br />
            <i class="far fa-question-circle" style="font-size:20px">&nbsp Do you have any questions ?
                Please do not hesitate to contact us directly . 
                Our team will come back to you within 
                a master of hours to help you &nbsp<i class="far fa-question-circle" style="font-size:20px"></i>
            </i><br />
            </section>
        </div> 
    <br />
<!--titre end-->
     ...
     <div class="contact-in">
        <div class="contact-map">
          <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d207.1067171482965!2d35.526707446304954!3d33.84565380496719!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x151f17bc935e2bf7%3A0xea8075b2ee69d2ff!2sChbib%20Aluminium!5e0!3m2!1sen!2slb!4v1633947069505!5m2!1sen!2slb" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
        </div>
        <div class="contact-form">
           <h1 style="background-color:#870c0c"><span style="font-size:26px">Send Us a Message</span></h1>
            <div id="form1">
            ...
            <asp:textbox ID="Txtemail" runat="server" placeholder="Email" class="contact-form-txt"/>
                <div style="margin-top:-20px">
                    ...
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="Txtemail" ErrorMessage="Invalid Email Adress !" Font-Size="20px" ForeColor="Red" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"></asp:RegularExpressionValidator>
